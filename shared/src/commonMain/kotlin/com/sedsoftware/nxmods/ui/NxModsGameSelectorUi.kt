            ...
            Box {
                when {
                    ...
                    model.emptyPlaceholderVisible -> {
                        Box(
                            ...
                            Text(
                                text = MainRes.string.game_selector_empty,
                ...
                AnimatedVisibility(
                    ...
                    ButtonMain(
                        ...
                        Text(
                            text = MainRes.string.game_selector_next,
    ...
    AnimatedVisibility(
        ...
        Row(
            ...
            Column(modifier = modifier.weight(1f)) {
                Text(
                    text = MainRes.string.game_selector_header,
                ...
                Text(
                    text = "${MainRes.string.game_selector_sub_header} ${model.bookmarkedCounter}",
                    color = MaterialTheme.colorScheme.onSurfaceVariant,
                    style = MaterialTheme.typography.titleMedium,
                    modifier = modifier.padding(horizontal = 32.dp)
                )
