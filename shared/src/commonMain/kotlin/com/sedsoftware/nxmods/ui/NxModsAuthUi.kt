    ...
    if (model.progressVisible) {
        ...
        Scaffold(
            ...
            topBar = {
                NxAppBar {
                    Text(
                        text = MainRes.string.auth_header,
                ...
                Column(modifier = modifier.fillMaxWidth()) {
                    Box(modifier = modifier.weight(1f)) {
                        Column(
                            ...
                            Text(
                                text = MainRes.string.auth_api_key,
                    ...
                    Box(modifier = modifier.weight(1f)) {
                        Column(
                            ...
                            Text(
                                text = MainRes.string.auth_api_key_desc,
                            ...
                            when (model.status) {
                                ApiKeyStatus.VALIDATION -> {
                                    Text(
                                        text = MainRes.string.auth_api_key_validation,
                                        color = MaterialTheme.colorScheme.primary
                                    )
                                }
                                ...
                                ApiKeyStatus.VALID -> {
                                    Text(
                                        text = MainRes.string.auth_api_key_valid,
                                ...
                                ApiKeyStatus.INVALID -> {
                                    Text(
                                        text = MainRes.string.auth_api_key_invalid,
                            ...
                            Row(
                                ...
                                ButtonMain(
                                    ...
                                    Text(
                                        text = MainRes.string.auth_button_validate,
                                ...
                                ButtonMain(
                                    ...
                                    Text(
                                        text = MainRes.string.auth_button_next,
                                        color = MaterialTheme.colorScheme.onPrimary
                                    )
                                }
                            }
